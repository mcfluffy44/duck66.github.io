...
<div class="container" style="margin-top:30px">
  <div class="jumbotron">
    ...
    <div class="container">
        ...
        <p class="lead">Halaman ini berisikan pertanyaan tentang apa yang anda rasakan.</p>
        <p class="lead">Untuk hasil yang sebenarnya, mari jawab dengan perasaan sebenarnya yang sedang dirasakan ^-^</p>
    </div>
    <div class="text-right">
        <a href="konsultasi3.html">
            <button type="button" class="btn btn-outline-success btn-lg">Mari Mulai \(^o^)/</button>
        </a>
    </div>
  </div>
</div>
